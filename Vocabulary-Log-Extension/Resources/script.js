...
function handleContextMenu(event) {
    ...
    let surroundingBlurb = window.getSelection().baseNode.parentElement.textContent
    ...
    safari.extension.setContextMenuEventUserInfo(event,
        { "term": selectedText, "exampleSentence": appropriateSentence, "url": window.location.hostname });
}
